...
type SecureChannel struct {
	...
	// errorHandler receive dispatcher errors and decides whether or not to forwards them,
	// if the return value is nil the pending handlers are disposed but if the value is EOF it ends the dispatcher
	// and disposes of the handlers.
